      ...
      <div className="mx-auto flex h-14 max-w-7xl items-center justify-between gap-3 px-4 lg:h-16 lg:px-8">
        <div className="flex min-w-0 items-center gap-3">
          ...
          <Link to="/" className="font-display truncate text-lg lg:text-xl">
            <span className="text-brand-800 font-bold">NearbyStay</span>
          </Link>
        </div>
        ...
        <nav className="hidden items-center gap-1 lg:flex">
          ...
          <Link
            to={createHubPath}
            className="rounded-lg px-3 py-2 text-sm font-medium text-stone-600 hover:bg-stone-50 hover:text-brand-600"
          >
            Create Hub
          </Link>
          <Link
            to={hostListPath}
            className="ml-1 rounded-lg border border-stone-300 px-4 py-2 text-sm font-medium text-stone-900 hover:border-brand-500 hover:text-brand-600"
          >
            List Your Space
          </Link>
        </nav>
